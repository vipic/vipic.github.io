import{c as n,r as e,m as t}from"./render-template.3xIYiyox.js";import{u as p}from"./hoisted.BLL4Jfoh.js";import"./astro/assets-service.DcMRmNXG.js";const a=`<p>我想在电视上安装个播放器来播放本地 NAS 里面的视频，网上能找到的方案都是特定品牌型号的电视有应用商店或者浏览器，可以自行安装 apk。我家里的两个刚好都没有这种解决方案，于是想到了很早之前调试安卓手机 webview 的时候用过 adb。尝试下确实可行，通过 adb 给电视安装应用流程如下。</p>
...
<p>安装命令执行完过一会应用就安装好了，一般不会出现问题，如果使用中遇到问题，可以谷歌查找 adb 相关命令来帮助排查。</p>`,i={title:"通过adb给电视安装任意应用",publishDate:"14 Mar 2024",description:"很多电视都不给用户安装预装的应用市场外的应用，而且这个应用市场内的应用数量稀少无法满足用户的需要。通过一点开发技巧可以实现安装任意apk",tags:["生活","技巧"],minutesRead:"3 min read"},d="/home/runner/work/blog/blog/src/content/post/tv-skill.md",l=void 0;function y(){return`
...
`}function u(){return a}function f(){return[{depth:2,slug:"安装-adb-工具",text:"安装 adb 工具"},{depth:2,slug:"电视开启调试模式",text:"电视开启调试模式"},{depth:2,slug:"连接电视安装-apk",text:"连接电视安装 apk"}]}const k=n((o,r,c)=>{const{layout:b,...s}=i;return s.file=d,s.url=l,e`${t()}${p(a)}`});export{k as Content,u as compiledContent,k as default,d as file,i as frontmatter,f as getHeadings,y as rawContent,l as url};
