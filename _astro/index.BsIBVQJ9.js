...
> 本文行文仓促，也是为了让博客有第一篇文章，所以内容上不够饱满，配图也有点粗糙。接下来尽量重新编排一下。感谢阅读~`,e={title:"设计的四个原则",description:'是"给大家看的设计书"的总结，只总结了设计的四个原则部分。后面其他章节的内容作为一个非设计专业可能不需要深入了解',publishDate:new Date(17097696e5),draft:!1,tags:["design"]},s={type:"content",filePath:"/home/runner/work/blog/blog/src/content/post/design-book/index.md",rawData:`
title: '设计的四个原则'
description: '是"给大家看的设计书"的总结，只总结了设计的四个原则部分。后面其他章节的内容作为一个非设计专业可能不需要深入了解'
publishDate: '7 Mar 2024'
tags: ['Design']`};export{s as _internal,i as body,t as collection,e as data,n as id,o as slug};
