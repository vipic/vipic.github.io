import{c as n,r as e,m as t}from"./render-template.DeXdV9vA.js";import{u as p}from"./hoisted.DoS_AEMc.js";import"./astro/assets-service.DcMRmNXG.js";const a=`<p>我想在电视上安装个播放器来播放本地 NAS 里面的视频，网上能找到的方案都是特定品牌型号的电视有应用商店或者浏览器，可以自行安装 apk。我家里的两个刚好都没有这种解决方案，于是想到了很早之前调试安卓手机 webview 的时候用过 adb。尝试下确实可行，通过 adb 给电视安装应用流程如下。</p>
...
`}function u(){return a}function f(){return[{depth:2,slug:"安装-adb-工具",text:"安装 adb 工具"},{depth:2,slug:"电视开启调试模式",text:"电视开启调试模式"},{depth:2,slug:"连接电视安装-apk",text:"连接电视安装 apk"}]}const k=n((o,r,c)=>{const{layout:b,...s}=d;return s.file=i,s.url=l,e`${t()}${p(a)}`});export{k as Content,u as compiledContent,k as default,i as file,d as frontmatter,f as getHeadings,y as rawContent,l as url};
