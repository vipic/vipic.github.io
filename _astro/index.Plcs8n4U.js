import{s as h,g as d}from"./_astro_assets.WugkUei9.js";import{c,r as g,m as u}from"./render-template.nO84Ig5l.js";import{u as m}from"./hoisted.DPGVcB6Z.js";import"./astro/assets-service.DcMRmNXG.js";const b={src:"/_astro/c.Cj4YNmbj.png",width:6723,height:3327,format:"png"},y=async function(o){const n={};{const s=new RegExp('__ASTRO_IMAGE_="([^"]*\\./c\\.png[^"]*)"',"g");let i,e=0;for(;(i=s.exec(o))!==null;){const t="./c.png_"+e,a=JSON.parse(i[1].replace(/&#x22;/g,'"')),{src:p,...r}=a;n[t]=await d({src:b,...r}),e++}}return n};async function f(o){return y(o).then(n=>o.replaceAll(/__ASTRO_IMAGE_="([^"]+)"/gm,(s,i)=>{const e=JSON.parse(i.replace(/&#x22;/g,'"')),t=e.src+"_"+e.index;n[t].srcSet&&n[t].srcSet.values.length>0&&(n[t].attributes.srcset=n[t].srcSet.attribute);const{index:a,...p}=n[t].attributes;return h({src:n[t].src,...p})}))}const l=await f(`<p>看完这本书后，我发现这并不是一本介绍专业设计原则的书，而更像是是一本具有实操的指导书：指导软件开发者从哪些角度以及用什么方法可以得到一个符合软件所需要功能的 UI，也指导设计从业者如何运用所学的设计知识来作出一个符合终端用户预期的软件页面。</p>
...
<p>例如这个页面</p>
<img __ASTRO_IMAGE_="{&#x22;src&#x22;:&#x22;./c.png&#x22;,&#x22;alt&#x22;:&#x22;Astro theme cactus logo&#x22;,&#x22;index&#x22;:0}">
<blockquote>
...
<blockquote>
<p>Look for decisions you wouldn’t have made</p>
</blockquote>`),w={title:"Refactoring UI",description:"作者读了一本关于应用设计的书，并将自己的感想和书中内容写成了本篇笔记作者读了一本关于应用设计的书，并将自己的感想和书中内容写成了本篇笔记",publishDate:"10 Jan 2024",tags:["Design","Develop"],draft:!0,minutesRead:"45 min read"},x="/home/runner/work/blog/blog/src/content/post/ui/index.md",v=void 0;function C(){return`
