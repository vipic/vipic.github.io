import{c as t,r as o,m as i}from"./render-template.CZ1g2pG9.js";import{u as s}from"./hoisted.C6EZNMjE.js";import"./astro/assets-service.CWtZdUDo.js";const e=`<p>看完这本书后，我发现这并不是一本介绍专业设计原则的书，而更像是是一本具有实操的指导书：指导软件开发者从哪些角度以及用什么方法可以得到一个符合软件所需要功能的 UI，也指导设计从业者如何运用所学的设计知识来作出一个符合终端用户预期的软件页面。</p>
...
<h4 id="limit-your-choices">Limit your choices</h4>
...
<h4 id="not-all-elements-are-equal">Not all elements are equal</h4>
...
<h4 id="size-isnt-everything">Size isn’t everything</h4>
...
<h4 id="dont-use-grey-text-on-colored-backgrounds">Don’t use grey text on colored backgrounds</h4>
...
<h4 id="emphasize-by-de-emphasizing">Emphasize by de-emphasizing</h4>
...
<h4 id="labels-are-a-last-resort">Labels are a last resort</h4>
...
<h4 id="separate-visual-hierarchy-from-document-hierarchy">Separate visual hierarchy from document hierarchy</h4>
...
<h4 id="balance-weight-and-contrast">Balance weight and contrast</h4>
...
<p>例如这个页面</p>
<p>![[./assets/CleanShot 2023-12-22 at 14.49.27.png]]</p>
<blockquote>
...
<p>栅格系统很有用，但也没那么有用。</p>
<h4 id="not-all-elements-should-be-fluid">Not all elements should be fluid</h4>
...
<h4 id="dont-shrink-an-element-until-you-need-to">Don’t shrink an element until you need to</h4>
...
<h4 id="play-it-safe">Play it safe</h4>
...
<h4 id="ignore-typefaces-with-less-than-five-weights">Ignore typefaces with less than five weights</h4>
<p>并不一定对，但是能够提供更多字重的字体肯定更看重细节和精心制作的。</p>
<p>这是一个你在选择字体时候的参考。</p>
<h4 id="optimize-for-legibility">Optimize for legibility</h4>
<p>用于标题的字体通常具有更紧凑的字母间距和较短的小写字母（较短的 x 高度），而用于较小尺寸的字体则具有更宽的字母间距和较高的小写字母。</p>
<p>上面是一个通识，遵守这个准没错。</p>
<h4 id="trust-the-wisdom-of-the-crowd">Trust the wisdom of the crowd</h4>
<p>实在不行就按 popular 排序，选择第一个结果。</p>
<h4 id="steal-from-people-who-care">Steal from people who care</h4>
<p>你喜欢的网站是什么字体，你就用什么。</p>
<h4 id="developing-your-intuition">Developing your intuition</h4>
<p>培养你的直觉。</p>
<h3 id="keep-your-line-length-in-check">Keep your line length in check</h3>
<p>根据情况让每行的字符数量不要太多，太多会影响阅读，至少换行的时候可能会找不到下一行。</p>
<h4 id="dealing-with-wider-content">Dealing with wider content</h4>
<p>即便有其他元素，也要限制段落宽度。</p>
<h4 id="baseline-not-center">Baseline, not center</h4>
<h4 id="line-height-is-proportional">Line-height is proportional</h4>
<blockquote>
...
<h4 id="not-every-link-needs-a-color">Not every link needs a color</h4>
...
<h4 id="align-with-readability-in-mind">Align with readability in mind</h4>
<p>你是 ltr 国家，那么居左对齐就行。</p>
<h4 id="dont-center-long-form-text">Don’t center long form text</h4>
...
<h4 id="right-align-numbers">Right-align numbers</h4>
<p>表格中数字元素居右。因为这样在数字有有效数字的情况下，右对齐能保证小数点在同一个位置，大致瞄一眼的情况下，这种布局非常容易。a lot easier to compare at a glance.</p>
<h4 id="hyphenate-justified-text">Hyphenate justified text</h4>
<p>可以通过 css 调整文字的对齐效果，避免一行文字过少，或者行尾空白过多等等问题。</p>
<h4 id="use-letter-spacing-effectively">Use letter-spacing effectively</h4>
...
<h4 id="what-you-actually-need">What you actually need</h4>
...
<h4 id="choose-the-base-color-first">Choose the base color first</h4>
<p>选择主色的标准是，选定一个颜色，它的不同色调用在按钮上，最适合当按钮的颜色就是主色。</p>
<h4 id="finding-the-edges">Finding the edges</h4>
<p>基于主色，再选一个最深和最浅。通常最深的色调用做文字颜色，最浅的用作背脊颜色。</p>
<h4 id="filling-in-the-gaps">Filling in the gaps</h4>
<p>将最深、主色、最浅排序，可以尝试给中间空出渐进的颜色空白。使整体保证有 7 个或者 9 个，这样能够让主色保持完美居中。再使用一致的比例生成出其余的颜色。</p>
<h4 id="what-about-greys">What about greys?</h4>
<p>灰色是使用前述颜色中最深的文字颜色更深一点做最深，最浅颜色的背景颜色更浅一点做最浅。</p>
<p>同理生成 7-9 个颜色。</p>
<h4 id="its-not-a-science">It’s not a science</h4>
...
<h4 id="overlapping-images">Overlapping images</h4>
...
<h4 id="dont-scale-up-icons">Don’t scale up icons</h4>
<p>即便不会失真的 svg 矢量图，放大的过大也会因原本小尺寸的设计过度放大而缺少细节显得粗糙。</p>
<p>假如图标想要放大怎么办呢，适当增加一个大体积的背景 (但是图标不要放大)。</p>
<h4 id="dont-scale-down-screenshots">Don’t scale down screenshots</h4>
...
<h4 id="dont-scale-down-icons-either">Don’t scale down icons, either</h4>
...
<h4 id="control-the-shape-and-size">Control the shape and size</h4>
<p>渲染的时候统一尺寸</p>
<h4 id="prevent-background-bleed">Prevent background bleed</h4>
...
<h4 id="change-the-background-color">Change the background color</h4>
<p>像是表格的隔行不同颜色一样，也可以在你的元素上做类似的调整。</p>
<p>或者在这个颜色上做渐变效果。</p>
<h4 id="use-a-repeating-pattern">Use a repeating pattern</h4>
<p>添加一些细微可重复的图案，这些图案也不用完全在整个背景上重复。在部分模块来重复就行。</p>
<h4 id="add-a-simple-shape-or-illustration">Add a simple shape or illustration</h4>
...
<h4 id="use-fewer-borders">Use fewer borders</h4>
<p>区分两个元素可以使用 border，但有时候使用 border 可能会让你的设计显得凌乱。后面会有一个去除 border 的方案</p>
<h4 id="use-a-box-shadow">Use a box shadow</h4>
<p>如果想要突出的元素和背景很近，那么使用阴影让突出的元素与周围区分开来。</p>
<h4 id="use-two-different-background-colors">Use two different background colors</h4>
<p>就像表格的间隔行不同颜色。</p>
<p>在这种情况下，相邻的元素有了足够的区分度。那这里如果存在 border 的话，就可以去掉了。</p>
<h4 id="add-extra-spacing">Add extra spacing</h4>
...
<blockquote>
<p>Look for decisions you wouldn’t have made</p>
</blockquote>`,a={title:"Refactoring UI",description:"作者读了一本关于应用设计的书，并将自己的感想和书中内容写成了本篇笔记作者读了一本关于应用设计的书，并将自己的感想和书中内容写成了本篇笔记",publishDate:"10 Jan 2024",tags:["Design","Develop"],draft:!0,minutesRead:"45 min read"},p="/home/runner/work/blog/blog/src/content/post/r-ui.md",l=void 0;function m(){return`
...
![[./assets/CleanShot 2023-12-22 at 14.49.27.png]]
...
> Look for decisions you wouldn’t have made
`}function y(){return e}function f(){return[{depth:4,slug:"limit-your-choices",text:"Limit your choices"},{depth:3,slug:"hierarchy-is-everything",text:"Hierarchy is Everything"},{depth:4,slug:"not-all-elements-are-equal",text:"Not all elements are equal"},{depth:4,slug:"size-isnt-everything",text:"Size isn’t everything"},{depth:4,slug:"dont-use-grey-text-on-colored-backgrounds",text:"Don’t use grey text on colored backgrounds"},{depth:4,slug:"emphasize-by-de-emphasizing",text:"Emphasize by de-emphasizing"},{depth:4,slug:"labels-are-a-last-resort",text:"Labels are a last resort"},{depth:4,slug:"separate-visual-hierarchy-from-document-hierarchy",text:"Separate visual hierarchy from document hierarchy"},{depth:4,slug:"balance-weight-and-contrast",text:"Balance weight and contrast"},{depth:2,slug:"layout-and-spacing",text:"Layout and Spacing"},{depth:3,slug:"start-with-too-much-white-space",text:"Start with too much white space"},{depth:3,slug:"establish-a-spacing-and-sizing-system",text:"Establish a spacing and sizing system"},{depth:3,slug:"you-dont-have-to-fill-the-whole-screen",text:"You don’t have to fill the whole screen"},{depth:4,slug:"shrink-the-canvas",text:"Shrink the canvas"},{depth:4,slug:"thinking-in-columns",text:"Thinking in columns"},{depth:4,slug:"dont-force-it",text:"Don’t force it"},{depth:3,slug:"grids-are-overrated",text:"Grids are overrated"},{depth:4,slug:"not-all-elements-should-be-fluid",text:"Not all elements should be fluid"},{depth:4,slug:"dont-shrink-an-element-until-you-need-to",text:"Don’t shrink an element until you need to"},{depth:3,slug:"relative-sizing-doesnt-scale",text:"Relative sizing doesn’t scale"},{depth:3,slug:"avoid-ambiguous-spacing",text:"Avoid ambiguous spacing"},{depth:2,slug:"designing-text",text:"Designing Text"},{depth:3,slug:"establish-a-type-scale",text:"Establish a type scale"},{depth:3,slug:"use-good-fonts",text:"Use good fonts"},{depth:4,slug:"play-it-safe",text:"Play it safe"},{depth:4,slug:"ignore-typefaces-with-less-than-five-weights",text:"Ignore typefaces with less than five weights"},{depth:4,slug:"optimize-for-legibility",text:"Optimize for legibility"},{depth:4,slug:"trust-the-wisdom-of-the-crowd",text:"Trust the wisdom of the crowd"},{depth:4,slug:"steal-from-people-who-care",text:"Steal from people who care"},{depth:4,slug:"developing-your-intuition",text:"Developing your intuition"},{depth:3,slug:"keep-your-line-length-in-check",text:"Keep your line length in check"},{depth:4,slug:"dealing-with-wider-content",text:"Dealing with wider content"},{depth:4,slug:"baseline-not-center",text:"Baseline, not center"},{depth:4,slug:"line-height-is-proportional",text:"Line-height is proportional"},{depth:4,slug:"not-every-link-needs-a-color",text:"Not every link needs a color"},{depth:4,slug:"align-with-readability-in-mind",text:"Align with readability in mind"},{depth:4,slug:"dont-center-long-form-text",text:"Don’t center long form text"},{depth:4,slug:"right-align-numbers",text:"Right-align numbers"},{depth:4,slug:"hyphenate-justified-text",text:"Hyphenate justified text"},{depth:4,slug:"use-letter-spacing-effectively",text:"Use letter-spacing effectively"},{depth:2,slug:"working-with-color",text:"Working with Color"},{depth:3,slug:"ditch-hex-for-hsl",text:"Ditch hex for HSL"},{depth:3,slug:"you-need-more-colors-than-you-think",text:"You need more colors than you think"},{depth:4,slug:"what-you-actually-need",text:"What you actually need"},{depth:3,slug:"define-your-shades-up-front",text:"Define your shades up front"},{depth:4,slug:"choose-the-base-color-first",text:"Choose the base color first"},{depth:4,slug:"finding-the-edges",text:"Finding the edges"},{depth:4,slug:"filling-in-the-gaps",text:"Filling in the gaps"},{depth:4,slug:"what-about-greys",text:"What about greys?"},{depth:4,slug:"its-not-a-science",text:"It’s not a science"},{depth:3,slug:"dont-let-lightness-kill-your-saturation",text:"Don’t let lightness kill your saturation"},{depth:2,slug:"creating-depth",text:"Creating Depth"},{depth:3,slug:"light-comes-from-above",text:"Light comes from above"},{depth:3,slug:"simulating-light-in-a-user-interface",text:"Simulating light in a user interface"},{depth:3,slug:"dont-get-carried-away",text:"Don’t get carried away"},{depth:2,slug:"use-shadows-to-convey-elevation",text:"Use shadows to convey elevation"},{depth:3,slug:"establishing-an-elevation-system",text:"Establishing an elevation system"},{depth:3,slug:"combining-shadows-with-interaction",text:"Combining shadows with interaction"},{depth:3,slug:"shadows-can-have-two-parts",text:"Shadows can have two parts"},{depth:4,slug:"accounting-for-elevation",text:"Accounting for elevation"},{depth:3,slug:"even-flat-designs-can-have-depth",text:"Even flat designs can have depth"},{depth:4,slug:"creating-depth-with-color",text:"Creating depth with color"},{depth:4,slug:"using-solid-shadows",text:"Using solid shadows"},{depth:3,slug:"overlap-elements-to-create-layers",text:"Overlap elements to create layers"},{depth:4,slug:"overlapping-images",text:"Overlapping images"},{depth:2,slug:"working-with-images",text:"Working with Images"},{depth:3,slug:"text-needs-consistent-contrast",text:"Text needs consistent contrast"},{depth:3,slug:"everything-has-an-intended-size",text:"Everything has an intended size"},{depth:4,slug:"dont-scale-up-icons",text:"Don’t scale up icons"},{depth:4,slug:"dont-scale-down-screenshots",text:"Don’t scale down screenshots"},{depth:4,slug:"dont-scale-down-icons-either",text:"Don’t scale down icons, either"},{depth:3,slug:"beware-user-uploaded-content",text:"Beware user-uploaded content"},{depth:4,slug:"control-the-shape-and-size",text:"Control the shape and size"},{depth:4,slug:"prevent-background-bleed",text:"Prevent background bleed"},{depth:2,slug:"finishing-touches",text:"Finishing Touches"},{depth:3,slug:"supercharge-the-defaults",text:"Supercharge the defaults"},{depth:3,slug:"add-color-with-accent-borders",text:"Add color with accent borders"},{depth:3,slug:"decorate-your-backgrounds",text:"Decorate your backgrounds"},{depth:4,slug:"change-the-background-color",text:"Change the background color"},{depth:4,slug:"use-a-repeating-pattern",text:"Use a repeating pattern"},{depth:4,slug:"add-a-simple-shape-or-illustration",text:"Add a simple shape or illustration"},{depth:3,slug:"dont-overlook-empty-states",text:"Don’t overlook empty states"},{depth:4,slug:"use-fewer-borders",text:"Use fewer borders"},{depth:4,slug:"use-a-box-shadow",text:"Use a box shadow"},{depth:4,slug:"use-two-different-background-colors",text:"Use two different background colors"},{depth:4,slug:"add-extra-spacing",text:"Add extra spacing"},{depth:3,slug:"think-outside-the-box",text:"Think outside the box"},{depth:2,slug:"leveling-up",text:"Leveling Up"}]}const w=t((r,h,d)=>{const{layout:c,...n}=a;return n.file=p,n.url=l,o`${i()}${s(e)}`});export{w as Content,y as compiledContent,w as default,p as file,a as frontmatter,f as getHeadings,m as rawContent,l as url};
